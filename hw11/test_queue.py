...
def main():
    ...
    str_result = str(queue1)
    if str_result == '1\n2\n3\n4\n5\n2\n':
        print('Correct: The string conversion method has the proper form.\n')
    else:
        print('ERROR: The string conversion method does not have ' \
            + 'the proper form')
        print('       OR the items are in the wrong order.\n')
